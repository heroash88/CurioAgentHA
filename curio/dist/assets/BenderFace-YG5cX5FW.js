import{r as t,j as e}from"./index-BOKrCxnc.js";const b=({state:i,modelTranscript:h,className:m})=>{const[p,n]=t.useState(0);t.useEffect(()=>{const r=setInterval(()=>{n(Math.floor(Math.random()*30)+1)},4e3+Math.random()*3e3);return()=>clearInterval(r)},[]),t.useEffect(()=>{const r=[],s=f=>{var l,c;const o=f,a=(l=o.detail)==null?void 0:l.action,d=(c=o.detail)==null?void 0:c.id;a==="special"&&typeof d=="number"?n(d):a==="nod"?(n(28),r.push(setTimeout(()=>n(0),1e3))):a==="bob"?(n(26),r.push(setTimeout(()=>n(0),1e3))):a==="blink"&&(n(29),r.push(setTimeout(()=>n(0),400)))};return window.addEventListener("curio:preview-animation",s),()=>{window.removeEventListener("curio:preview-animation",s),r.forEach(clearTimeout)}},[]);const _=t.useMemo(()=>{switch(i){case"speaking":return"speaking";case"listening":return"listening";case"thinking":return"thinking";case"warmup":return"warmup";case"dancing":return"dancing";case"error":return"error";default:return"idle"}},[i]),u=`anim-${p}`;return e.jsxs("div",{className:`Bender ${_} ${u} ${m??""}`,children:[e.jsx("style",{children:`
        .Bender {
          height: 100%;
          width: 100%;
          display: flex;
      ...
      `}),e.jsx("div",{className:"Bender__eyes",children:e.jsxs("div",{className:"Bender__socket",children:[e.jsx("div",{className:"Bender__eye",children:e.jsx("div",{className:"Bender__pupil"})}),e.jsx("div",{className:"Bender__eye",children:e.jsx("div",{className:"Bender__pupil"})})]})}),e.jsxs("div",{className:"Bender__mouth",children:[e.jsx("div",{className:"Bender__tooth"}),e.jsx("div",{className:"Bender__tooth"}),e.jsx("div",{className:"Bender__tooth"}),e.jsx("div",{className:"Bender__tooth"}),e.jsx("div",{className:"Bender__tooth"}),e.jsx("div",{className:"Bender__lip"}),e.jsx("div",{className:"Bender__lip"})]})]})};export{b as default};
